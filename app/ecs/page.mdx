...
- `gameOverSystem`: Detect win/loss conditions and show a message. Updated `appearance` and `renderSystem` with some _very_ basic text rendering to support this.
...
If you do too, check out [Episode 2: More Zombies in a Bigger Room](/ecs-demo) or the [project repo](https://github.com/zackrdavis/minimal-ECS).

Thanks to those who helped this project along with pair-programming, writing advice and gameplay ideas: [Stella Choi](https://www.stellalchoi.com/), [Michelle Bernstein](https://github.com/plocket), [Samuel Selleck](https://samuelselleck.com/), [Reed Spool](https://reeds.website/), Joseph Jorgensen and Zach Rose.
