...
A few nice surprises showed up when everything was working together. Zombie movement looks good and feels unpredictable – you wait and hope they won't lurch your way. Bouncing off walls is a free solution to keeping zombies in the mix without any directional guidance. Higher-level, there seem to be two main approaches you can take to the game: billiards-style, focused on shooting a survivor into the goal quickly, or bodyguard style, inching them along and shoving zombies away. And I like that you can stand guard in the broom-closet entrance while you get a sense for how zombies move.
...
Thanks to those who helped this project along with pair-programming, writing advice and gameplay ideas: [Stella Choi](https://www.stellalchoi.com/), [Michelle Bernstein](https://github.com/plocket), [Samuel Selleck](https://samuelselleck.com/), Reed Spoole, Joseph Jorgensen and Zach Rose.
